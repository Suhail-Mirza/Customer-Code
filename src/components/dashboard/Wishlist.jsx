   ...
   useEffect(() => { 
    ...
    return (
        <div className='w-full grid grid-cols-4 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6'>
            {
                wishlist.map((p, i) => <div key={i} className='border-amber-100 border-1 group transition-all duration-500 hover:shadow-md hover:-mt-3 bg-white'>
            ...
            <ul className='flex transition-all duration-700 -bottom-10 justify-center items-center gap-2 absolute w-full group-hover:bottom-3'>
                <li onClick={() => dispatch(remove_wishlist(p._id))} className='w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded-full hover:rotate-[720deg] transition-all'>
                <FaHeart  className='text-[#059473]'/>
                </li>
                ...
                <li onClick={() => add_card(p.productId)} className='w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded-full hover:bg-[#059473] hover:text-white hover:rotate-[720deg] transition-all'>
                <RiShoppingCartLine />
                </li>
            </ul>    
                </div>
