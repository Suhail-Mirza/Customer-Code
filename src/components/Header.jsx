...
const Header = () => {
    ...
    return (
        ...
        <div className='w-white'>
         <div className='w-[85%] lg:w-[90%] mx-auto'>
            <div className='h-[115px] md-lg:h-[100px] flex justify-between items-center flex-wrap'>
                <div className='md-lg:w-full w-3/12 md-lg:pt-4'>
                <Link to='/' className='align-middle justify-center flex'>
  ...
  <div onClick={() => navigate(userInfo ? '/dashboard/my-wishlist' : '/login') } className='relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] rounded-full bg-[#e2e2e2]'>
    ...
    <div className='w-[85%] lg:w-[90%] mx-auto'>
        ...
        <div className={`${categoryShow ? 'h-0' : 'h-[400px]'} overflow-y-scroll transition-all md-lg:relative duration-500 absolute z-[99999] bg-[#dbf3ed] w-full border-x`}>
            <ul className='py-2 text-slate-600 font-medium'>
                {
                    categorys.map((c,i) => {
                        return (
                         <li onClick={() => setCategoryShow(!categoryShow) } key={i} className='flex justify-start items-center gap-2 px-[24px] py-[6px]'>
