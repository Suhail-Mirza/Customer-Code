...
const stripePromise=loadStripe('pk_test_51Rlxy9I5tvgzviVcAQNwGSCWsyfIgiOs82VVJiBBswOEtscbdhVhy2vFbeGZvdEqWoTnEVSv9hwrozGqtjcY2ZO50067xJLenC')
...
const Stripe = ({ price, orderId }) => {
    ...
    const create_payment = async () => {
        try {
            const { data } = await axios.post('https://backend-ecommerce-api-2zqg.onrender.com/api/order/create-payment',{price},{withCredentials:true})
